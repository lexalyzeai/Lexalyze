...
export default function DashboardPage() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#0A0A0A]">
      ...
      {/* Sidebar */}
      <aside className="flex h-screen w-[260px] shrink-0 flex-col border-r border-white/[0.06] bg-[#111111]">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="flex min-h-full flex-col items-center justify-start p-6 sm:p-10">
