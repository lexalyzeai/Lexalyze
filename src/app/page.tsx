    ...
    <main className="min-h-screen bg-[#050505] text-[#F3F4F6] selection:bg-[#C9A84C]/30 selection:text-white">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10">
        <svg className="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
          ...
          <g filter="url(#glow)">
            <path d="M0,100 Q200,150 400,100 T800,120 T1200,80 T1600,100" fill="none" stroke="#C9A84C" strokeWidth="1.5" opacity="0.3" />
            <path d="M0,200 Q250,250 500,200 T1000,220 T1500,180" fill="none" stroke="#C9A84C" strokeWidth="1" opacity="0.2" />
            <path d="M0,500 Q300,450 600,500 T1200,480 T1600,520" fill="none" stroke="#8B7355" strokeWidth="1" opacity="0.18" />
            <path d="M0,600 Q200,650 400,600 T800,620 T1200,580 T1600,600" fill="none" stroke="#C9A84C" strokeWidth="1.5" opacity="0.22" />
            <path d="M100,0 Q150,200 100,400 T150,800 T100,1200" fill="none" stroke="#C9A84C" strokeWidth="1" opacity="0.2" />
            <path d="M1400,0 Q1450,200 1400,400 T1450,800 T1400,1200" fill="none" stroke="#C9A84C" strokeWidth="1" opacity="0.2" />
            <circle cx="200" cy="150" r="3" fill="#C9A84C" opacity="0.4" />
            <circle cx="600" cy="250" r="2" fill="#C9A84C" opacity="0.35" />
            <circle cx="1000" cy="180" r="3" fill="#C9A84C" opacity="0.4" />
            <circle cx="1400" cy="220" r="2" fill="#C9A84C" opacity="0.35" />
            <circle cx="300" cy="550" r="2" fill="#8B7355" opacity="0.3" />
            <circle cx="700" cy="620" r="3" fill="#C9A84C" opacity="0.35" />
          </g>
        </svg>
      </div>
